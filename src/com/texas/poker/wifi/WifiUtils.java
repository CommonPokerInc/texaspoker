...
public class WifiUtils {
    ...
    public void createWiFiAP(WifiConfiguration paramWifiConfiguration, boolean paramBoolean) {
        try {
            Method localMethod = mWifiManager.getClass().getMethod("setWifiApEnabled", WifiConfiguration.class,boolean.class);
            localMethod.invoke(mWifiManager, paramWifiConfiguration,paramBoolean);
            return;
        }
        catch (Exception localException) {
        }
