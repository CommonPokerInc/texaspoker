...
public class WifiApConst {
    ...
    // WifiAP 参数
    public static final String PACKAGE_NAME = "com.texas.poker";
    public static final String FIRST_OPEN_KEY = "version";
    public static final String WIFI_AP_HEADER = "Poker_";
    public static final String WIFI_AP_PASSWORD = "frankchan";
}