package com.texas.poker.wifi.receiver;

import com.texas.poker.wifi.WifiHotManager.OpretionsType;
import com.texas.poker.wifi.WifiHotManager.WifiBroadCastOperations;
...
public class WifiStateBroadCast extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		if (WifiManager.WIFI_STATE_CHANGED_ACTION.equals(intent.getAction())) {
			...
			Log.i("WIFI״̬", "wifiState" + wifiState);
			switch (wifiState) {
